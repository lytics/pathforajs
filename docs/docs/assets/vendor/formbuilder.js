...
function formBuilderHelpersFn(opts, formBuilder) {
  ...
  _helpers.classNames = function (field, previewData) {
    ...
    var className = field[0].querySelector('.fld-className') ? field[0].querySelector('.fld-className').value : 'form-control';
  ...
  var FormBuilder = function FormBuilder(options, element) {
    ...
    var defaults = {
      ...
      messages: {
        ...
        minOptionMessage: 'This field requires a minimum of 1 option',
